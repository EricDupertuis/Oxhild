...
use Oxhild\ApiBundle\Entity\Artist;
use Oxhild\ApiBundle\Entity\Rarity;
use Oxhild\ApiBundle\Entity\Subtype;
use Oxhild\ApiBundle\Entity\Supertype;
use Oxhild\ApiBundle\Entity\Card;
use Oxhild\ApiBundle\Entity\Set;
use Oxhild\ApiBundle\Entity\Settype;
use Oxhild\ApiBundle\Entity\Layout;
use Oxhild\ApiBundle\Entity\Type;
use Oxhild\ApiBundle\Entity\Color as MtgColor;
use \DateTime;
...
class ImportCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($data as $content) {
            ...
            $searchSet = $this->em->getRepository('OxhildApiBundle:Set')
            ...
            if ($searchSet === null) {
                ...
                $type = $this->em->getRepository('OxhildApiBundle:Settype')
                ...
                foreach ($content['cards'] as $cardData) {
                    ...
                    // Layout
                    $searchLayout = $this->em->getRepository('OxhildApiBundle:Layout')
                    ...
                    if (isset($cardData['types'])) {
                        foreach($cardData['types'] as $cardType) {
                            ...
                            $searchType = $this->em->getRepository('OxhildApiBundle:Type')
                    ...
                    if  (isset($cardData['colors'])) {
                        foreach($cardData['colors'] as $color) {
                            $searchColor = $this->em->getRepository('OxhildApiBundle:Color')
                    ...
                    if (isset($cardData['subtypes'])) {
                        foreach ($cardData['subtypes'] as $subtype) {
                            $searchSubt = $this->em->getRepository('OxhildApiBundle:Subtype')
                    ...
                    if (isset($cardData['supertypes'])) {
                        foreach ($cardData['supertypes'] as $supertype) {
                            $searchSt = $this->em->getRepository('OxhildApiBundle:Supertype')
                    ...
                    // Rarity
                    $searchRarity = $this->em->getRepository('OxhildApiBundle:Rarity')
                    ...
                    // Artist
                    $searchArtist = $this->em->getRepository('OxhildApiBundle:Artist')
